...
abstract class $CommentRequestCopyWith<$Res> {
  ...
  $Res call({String postId, String comment, String? parentCommentId});
}
...
class __$$_CommentRequestCopyWithImpl<$Res>
  ...
  __$$_CommentRequestCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_CommentRequest));

  @override
  _$_CommentRequest get _value => super._value as _$_CommentRequest;
...
class _$_CommentRequest implements _CommentRequest {
  _$_CommentRequest(
      {required this.postId, required this.comment, this.parentCommentId});
  ...
  @override
  String toString() {
    return 'CommentRequest(postId: $postId, comment: $comment, parentCommentId: $parentCommentId)';
  }
...
abstract class _CommentRequest implements CommentRequest {
  factory _CommentRequest(
      {required final String postId,
      required final String comment,
      final String? parentCommentId}) = _$_CommentRequest;
